...
static int ijkl2intindexBTF(int i, int j, int k, int l); // added to COULOMB.py by B. Blasiak!
...
static PyObject *ijkl2intindexBTF_wrap(PyObject *self,PyObject *args); // added!
