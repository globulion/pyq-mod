     ...
     for (iy=0; iy<(ky+1); iy++)
        for (iz=0; iz<(kz+1); iz++)
            total = binomial(kx,ix)*binomial(ky,iy)*binomial(kz,iz)*
                    pow(xa,kx-ix)*pow(ya,ky-iy)*pow(za,kz-iz)*
                    overlap(alpha1,l1+ix,m1+iy,n1+iz,xa,ya,za,
                            alpha2,l2,m2,n2,xb,yb,zb) + total;
  return total;
}
...
// this function has been added by B. Blasiak to COULOMB.py
// BTF = means 'between two fragments'
static int ijkl2intindexBTF(int i, int j, int k, int l){
  int ij,kl;
  if (i<j) return ijkl2intindexBTF(j,i,k,l);
  if (k<l) return ijkl2intindexBTF(i,j,l,k);
  ij = i*(i+1)/2+j;
  kl = k*(k+1)/2+l;
  return ij*(ij+1)/2+kl;
}
...
// ADDED FOR COULOMB.py purposes!
static PyObject *ijkl2intindexBTF_wrap(PyObject *self,PyObject *args){
  int ok = 0,i,j,k,l;
  ok = PyArg_ParseTuple(args,"iiii",&i,&j,&k,&l);
  if (!ok) return NULL;
  return Py_BuildValue("i",ijkl2intindexBTF(i,j,k,l));
}
...
static PyObject *overlap_1x_wrap(PyObject *self,PyObject *args){
  int ok=0,l1,m1,n1,l2,m2,n2;
  double xa,ya,za,xb,yb,zb,alpha1,alpha2;
  PyObject *A,*B,*powa,*powb;
  ...
  return Py_BuildValue("d",
		       overlap_1x(alpha1,l1,m1,n1,xa,ya,za,
			          alpha2,l2,m2,n2,xb,yb,zb));
}

static PyObject *overlap_1y_wrap(PyObject *self,PyObject *args){
  int ok=0,l1,m1,n1,l2,m2,n2;
  double xa,ya,za,xb,yb,zb,alpha1,alpha2;
  PyObject *A,*B,*powa,*powb;
  ...
  return Py_BuildValue("d",
		       overlap_1y(alpha1,l1,m1,n1,xa,ya,za,
			          alpha2,l2,m2,n2,xb,yb,zb));
}

static PyObject *overlap_1z_wrap(PyObject *self,PyObject *args){
  int ok=0,l1,m1,n1,l2,m2,n2;
  double xa,ya,za,xb,yb,zb,alpha1,alpha2;
  PyObject *A,*B,*powa,*powb;
  ...
  return Py_BuildValue("d",
		       overlap_1z(alpha1,l1,m1,n1,xa,ya,za,
			          alpha2,l2,m2,n2,xb,yb,zb));
}

static PyObject *kinetic_1x_wrap(PyObject *self,PyObject *args){
  int ok=0,l1,m1,n1,l2,m2,n2;
  double xa,ya,za,xb,yb,zb,alpha1,alpha2;
  PyObject *A,*B,*powa,*powb;
  ...
  return Py_BuildValue("d",
		       kinetic_1x(alpha1,l1,m1,n1,xa,ya,za,
			          alpha2,l2,m2,n2,xb,yb,zb));
}

static PyObject *kinetic_1y_wrap(PyObject *self,PyObject *args){
  int ok=0,l1,m1,n1,l2,m2,n2;
  double xa,ya,za,xb,yb,zb,alpha1,alpha2;
  PyObject *A,*B,*powa,*powb;
  ...
  return Py_BuildValue("d",
		       kinetic_1y(alpha1,l1,m1,n1,xa,ya,za,
			          alpha2,l2,m2,n2,xb,yb,zb));
}

static PyObject *kinetic_1z_wrap(PyObject *self,PyObject *args){
  int ok=0,l1,m1,n1,l2,m2,n2;
  double xa,ya,za,xb,yb,zb,alpha1,alpha2;
  PyObject *A,*B,*powa,*powb;
  ...
  return Py_BuildValue("d",
		       kinetic_1z(alpha1,l1,m1,n1,xa,ya,za,
			          alpha2,l2,m2,n2,xb,yb,zb));
}
...
static PyObject *multipole_wrap(PyObject *self,PyObject *args){
  ...
  double xa,ya,za,xb,yb,zb,alpha1,alpha2;
  PyObject *A,*B,*powa,*powb,*pows;


  ok = PyArg_ParseTuple(args,"dOOdOOO",&alpha1,&powa,&A,&alpha2,
			&powb,&B,&pows);
  if (!ok) return NULL;
  ...
  ok = PyArg_ParseTuple(pows,"iii",&kx,&ky,&kz);
  if (!ok) return NULL;


  return Py_BuildValue("d",
		       multipole(kx,ky,kz,
                                 alpha1,l1,m1,n1,xa,ya,za,
				 alpha2,l2,m2,n2,xb,yb,zb));
}
...
static PyMethodDef cints_methods[] = {
  ...
  {"ijkl2intindexBTF",ijkl2intindexBTF_wrap,METH_VARARGS},  // Added for COULOMB.py!
  ...
  {"kinetic_1x",kinetic_1x_wrap,METH_VARARGS}, // Added for COULOMB.py!
  {"overlap_1x",overlap_1x_wrap,METH_VARARGS}, // Added for COULOMB.py!
  {"kinetic_1y",kinetic_1y_wrap,METH_VARARGS}, // Added for COULOMB.py!
  {"overlap_1y",overlap_1y_wrap,METH_VARARGS}, // Added for COULOMB.py!
  {"kinetic_1z",kinetic_1z_wrap,METH_VARARGS}, // Added for COULOMB.py!
  {"overlap_1z",overlap_1z_wrap,METH_VARARGS}, // Added for COULOMB.py!
