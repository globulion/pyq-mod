...
if enable_libint:
    ...
    for part in ["libint","libderiv","libr12"]:
        libint_static += glob.glob("/home/globula/Packages/libint-1.1.4/src/lib/%s/tmp/%s/.libs/*.o"%(part,part))
#         libint_static += glob.glob("libint-1.1.4/src/lib/%s/tmp/%s/*.o"%(part,part))        
#         libint_static += glob.glob("libint-2.0.0-stable/src/*.o")        
    ...
    libint_includes = ["/home/globula/Packages/libint-1.1.4/include/libint"] # Libint include dir
