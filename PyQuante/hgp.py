...
def contr_hrr(xa_ya_za,norma,la_ma_na,aexps,acoefs,
              xb_yb_zb,normb,lb_mb_nb,bexps,bcoefs,
              xc_yc_zc,normc,lc_mc_nc,cexps,ccoefs,
              xd_yd_zd,normd,ld_md_nd,dexps,dcoefs):
...
def contr_hrr_iter(xa_ya_za,norma,la_ma_na,aexps,acoefs,
                   xb_yb_zb,normb,lb_mb_nb,bexps,bcoefs,
                   xc_yc_zc,normc,lc_mc_nc,cexps,ccoefs,
                   xd_yd_zd,normd,ld_md_nd,dexps,dcoefs):
...
def contr_vrr(xa_ya_za,norma,la_ma_na,aexps,acoefs,
              xb_yb_zb,normb,bexps,bcoefs,
              xc_yc_zc,normc,lc_mc_nc,cexps,ccoefs,
              xd_yd_zd,normd,dexps,dcoefs):
...
def hrr(xa_ya_za,norma,la_ma_na,alphaa,
...
def vrr_recursive(xa_ya_za,norma,la_ma_na,alphaa,
        xb_yb_zb,normb,alphab,
        xc_yc_zc,normc,lc_mc_nc,alphac,
        xd_yd_zd,normd,alphad,m):
...
def vrr(xa_ya_za,norma,la_ma_na,alphaa,
        xb_yb_zb,normb,alphab,
        xc_yc_zc,normc,lc_mc_nc,alphac,
        xd_yd_zd,normd,alphad,M):
